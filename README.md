...
- **Задача/Мероприятие:** название, описание, дата, ответственный  
- **Статус:** «Очередь», «В работе», «На проверке», «Готово»
...
- Возможные расходы: хостинг (от 2000р/месяц), публикация бота (бесплатно)  
- MIT License
